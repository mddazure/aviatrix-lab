resource "aviatrix_transit_gateway" "transit_gw_2-int" {
  cloud_type        = 8
...
resource "aviatrix_spoke_gateway" "spoke_21_gw-int" {
  cloud_type        = 8
  account_name      = var.account-name-int
  ...
  gw_size           = "Standard_DS2_v2"
  gw_name           = "spoke-gw-21-int"
  allocate_new_eip  = true
}
resource "aviatrix_spoke_gateway" "spoke_22_gw-int" {
  cloud_type        = 8
  account_name      = var.account-name-int
  ...
  gw_size           = "Standard_DS2_v2"
  gw_name           = "spoke-gw-22-int"
  allocate_new_eip  = true
}
resource "aviatrix_spoke_gateway" "spoke_23_gw-int" {
  cloud_type        = 8
  account_name      = var.account-name-int
  ...
  gw_size           = "Standard_DS2_v2"
  gw_name           = "spoke-gw-23-int"
  allocate_new_eip  = true
}
resource "aviatrix_spoke_gateway" "spoke_24_gw-int" {
  cloud_type        = 8
  account_name      = var.account-name-int
  ...
  gw_size           = "Standard_DS2_v2"
  gw_name           = "spoke-gw-24-int"
  allocate_new_eip  = true
}
resource "aviatrix_spoke_transit_attachment" "spoke21-transit-int" {
  spoke_gw_name = aviatrix_spoke_gateway.spoke_21_gw-int.gw_name
  transit_gw_name = aviatrix_transit_gateway.transit_gw_2-int.gw_name 
}
resource "aviatrix_spoke_transit_attachment" "spoke22-transit-int" {
  spoke_gw_name = aviatrix_spoke_gateway.spoke_22_gw-int.gw_name
  transit_gw_name = aviatrix_transit_gateway.transit_gw_2-int.gw_name 
}
resource "aviatrix_spoke_transit_attachment" "spoke23-transit-int" {
  spoke_gw_name = aviatrix_spoke_gateway.spoke_23_gw-int.gw_name
  transit_gw_name = aviatrix_transit_gateway.transit_gw_2-int.gw_name 
}
resource "aviatrix_spoke_transit_attachment" "spoke24-transit-int" {
  spoke_gw_name = aviatrix_spoke_gateway.spoke_24_gw.gw_name
  transit_gw_name = aviatrix_transit_gateway.transit_gw_2-int.gw_name 
}
resource "aviatrix_transit_gateway_peering" "transit1-2-int"{
    transit_gateway_name1 = aviatrix_transit_gateway.transit_gw-int.gw_name
    transit_gateway_name2 = aviatrix_transit_gateway.transit_gw_2-int.gw_name
}
